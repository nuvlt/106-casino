...
export default async function GirisPage({
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col items-center justify-center px-6">
      <div className="w-full rounded-3xl border border-white/10 bg-surface p-8 text-center shadow-2xl">
        <h1 className="font-display text-4xl font-bold text-gold">106 Casino</h1>
        <p className="mt-3 text-sm text-white/60">
          Ofis içi oyun platformu. Gerçek para yok — herkese her gün 1.000 coin.
        </p>

        {error ? (
          <p className="mt-6 rounded-xl bg-lose/15 px-4 py-3 text-sm text-lose">
